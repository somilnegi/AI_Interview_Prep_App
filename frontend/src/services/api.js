...
export const MULTIMODAL_BASE =
  import.meta.env.VITE_MULTIMODAL_URL || "http://localhost:8001";
...
export const interviewAPI = {
  ...
  nextQuestion: (interviewId) =>
    api.post("/interview/next-question", { interviewId }),
};
...
export const multimodalAPI = {
  analyse: async (audioBlob, transcript = "") => {
    ...
    const res = await fetch(`${MULTIMODAL_BASE}/analyse`, {
      method: "POST",
      body: fd,
    });
    if (!res.ok) {
